...
def wisdom_potion():
    return f"Wisdom potion brewed with all elements: {alchemy.elements.create_earth()}, {alchemy.elements.create_fire()}, {alchemy.elements.create_water()} and {alchemy.elements.create_air()}"