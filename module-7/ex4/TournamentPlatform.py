"""
TournamentPlatform - Platform management system
...
class TournamentPlatform:
    """
    Tournament platform for managing competitive card matches.
    
    Features:
    - Card registration with unique IDs
    ...
    def __init__(self):
        ...
        self._cards = {}  # card_id -> TournamentCard
        self._matches_played = 0
        self._match_history = []
        self._id_counters = {}  # Track counter per card type
    ...
    def register_card(self, card: TournamentCard) -> str:
        ...
        Returns:
            str: Unique card ID
        """
        # Generate a unique ID based on card type
        # Extract second word of card name for simpler ID
        name_parts = card._name.lower().split()
        if len(name_parts) >= 2:
            base_id = name_parts[1]  # e.g., "dragon" from "Fire Dragon"
        else:
    ...
    def create_match(self, card1_id: str, card2_id: str) -> dict:
        ...
        Args:
            card1_id: First card's ID
            card2_id: Second card's ID
        
        Returns:
            dict: Match result including winner, loser, and updated ratings
        """
        ...
        winner_id, loser_id = self._simulate_combat(card1_id, card1, card2_id, card2)
    ...
    def _simulate_combat(self, card1_id: str, card1: TournamentCard, 
        ...
        """
        Simulate combat between two cards.
    ...
    def get_leaderboard(self) -> list:
        ...
        Returns:
            list: List of card info dictionaries sorted by rating (highest first)
        """
        leaderboard = []
    ...
    def generate_tournament_report(self) -> dict:
        ...
        total_rating = sum(card.calculate_rating() for card in self._cards.values())
        ...
        return {
            ...
            'platform_status': 'active' if self._matches_played > 0 else 'initialized'
        }
    ...
    def get_card(self, card_id: str) -> TournamentCard:
        ...
        Returns:
            TournamentCard: The card, or None if not found
        """
    ...
    def get_all_cards(self) -> dict:
        ...
        Returns:
            dict: Dictionary of card_id -> TournamentCard
        """
